...
<head>
    <meta charset="UTF-8">
    <title>Perpustakaan Online || Membaca menjadi lebih mudah!</title>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="alert alert-info alert-dismissable">
                            ...
                            <b>Selamat Datang di Perpustakaan Online, Untuk Login silahkan klik Icon User atau klik <a href="login.html">disini</a></b>
                        </div>
                    </div>
                                ...
                                <div class="twt-area">
                                    <form class="form-horizontal style-form" style="margin-top: 20px;" action="insert-pengunjung.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <textarea rows="4" name="saran" id="saran" class="form-control" placeholder="Saran Anda untuk Perpustakaan Online" cols="25"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Perpustakaan Online</h4>
                </div>
                <div class="modal-body">
                    <p> Perpustakaan Online adalah salah satu layanan bagi pengguna untuk dapat mengakses berbagai buku bacaan yang dan dilakukan kapan saja dan dari mana saja, dengan menggunakan jaringan internet.</p>
                    <p> Perpustakaan Online memiliki koleksi buku dalam bentuk format digital dan bisa diakses dengan komputer. koleksi bacaan dari PerpustakaanKu dapat diakses dengan cepat dan mudah lewat jaringan komputer.</p>
                    <p> Perpustakaan Online bebasis website yang responsif, untuk info, saran, maupun kritik bisa menghubungi kami :</p>
                    <table>
                        <tr>
                            <td>E-mail</td>
                            <td>:</td>
                            <td>Perpustakaanonline@gmail.com</td>
                        </tr>
                        <br />
                    </table>
                </div>
