...
<body background="img/page-background.png">
  ...
  <div class="container">
    ...
    <form class="form-signin" action="insert-anggota.php" method="post">
      <center>
        <h2 class="form-signin-heading"><span class="glyphicon glyphicon-th-large"></span> Perpustakaan Online </h2>
      </center>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p> Perpustakaan Online adalah salah satu layanan bagi pengguna untuk dapat mengakses berbagai buku bacaan yang dan
            dilakukan kapan saja dan dari mana saja, dengan menggunakan jaringan internet.</p>
          <p> Perpustakaan Online memiliki koleksi buku dalam bentuk format digital dan bisa diakses dengan komputer. koleksi
            bacaan dari Perpustakaan Online dapat diakses dengan cepat dan mudah lewat jaringan komputer.</p>
          <p> Perpustakaan Online bebasis website yang responsif, untuk info, saran, maupun kritik bisa menghubungi kami :
          </p>
          <table>
            <tr>
              <td>E-mail</td>
              <td>:</td>
              <td><a href="sisteminformasi494@gmail.com">PerpustakaanOnline@gmail.com</a></td>
            </tr>
            <br />
            <tr>
